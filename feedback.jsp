...
<body>
  ...
  %>
                  <table width="693" border="0" align="center">
                    ...
                    <tr>
                      <td><div align="center">Seller Id </div></td>
                      <td><input type="text" name="name2" value="<%String sid=request.getParameter("sid"); out.println(sid);%>"/></td>
                    </tr>
                    <tr>
...
try
{
	...
	String sid1=request.getParameter("name2");
