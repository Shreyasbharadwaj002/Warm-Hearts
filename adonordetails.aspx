<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adonordetails.aspx.cs" Inherits="adonordetails" %>
      ...
      <header class="main-header clearfix" >
          ...
          <nav id="nav" class="main-nav" role="navigation">
              <ul class="main-menu">
                  ...
                  <li><a href="dondetails.aspx">Donor's details</a></li>
                  ...
                  <div class="col-md-12">
                      <p>
                          <h3 style="color:aliceblue">DONOR DETAILS</h3>
                              ...
                              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [id], [name], [email], [phno], [address], [password] FROM [donor]"></asp:SqlDataSource>
                    </div>
                </div>
              </div>             
