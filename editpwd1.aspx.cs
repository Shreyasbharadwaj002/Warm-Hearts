...
public partial class editpwd1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlConnection con1;
    String eid = "", s = "";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            eid = Session["emailid"].ToString();

            s = "select * from receiver where emailid=" + "'" + eid + "'" + " and  password=" + "'" + TextBox2.Text + "'";
            //Response.Write(s);
            con.Open();
            ...
            if (ctr == 1)
            {
                ...
                s = "update receiver  set password=@p where emailid=@eid";
