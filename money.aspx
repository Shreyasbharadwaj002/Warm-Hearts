...
<body>
      ...
      <p>
        ...
        <div>
                        ...
                        <center><h1 style="color:aliceblue">DONATE FOR ORPHANAGE USING THESE PHONE NUMBERS</h1>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Height="100px" Width="1300px" style="color:aliceblue" >
                                <Columns>
                                    <asp:BoundField DataField="name" HeaderText="Orphanage Name" SortExpression="name" />
                                    <asp:BoundField DataField="email" HeaderText="Email" SortExpression="email" />
                                    <asp:BoundField DataField="phno" HeaderText="Phone Number" SortExpression="phno" />
                                    
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name], [phno], [email] FROM [orphanage]"></asp:SqlDataSource>
            </form>
</body>
</html>
