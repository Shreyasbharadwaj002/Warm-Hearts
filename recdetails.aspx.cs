...
public partial class recdetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string s = "select name,email,phno as FullName,Emailid,Mobile Number from receiver";// where clientemail =" + "'" + em + "'";
            ...
            if (ctr > 0)
            {
                ...
                string str11 = "select * from receiver";// where clientemail =" + "'" + em + "'";
