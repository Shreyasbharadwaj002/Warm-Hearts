...
-->
 ...
 <header class="main-header clearfix">
          ...
          <div class="video-overlay header-text">
              <div class="caption">
                  ...
                  <div class="main-button">
                      <div class="scroll-to-section"><a href="#section2">Join with us</a></div>
                  </div>
              </div>
          </div>
      </section>
                      ...
                      <div class="features-post">
                          <div class="features-content">
                              ...
                              <div class="content-hide">
                                  ...
                                  <div class=""><a href="about.aspx">More Info.</a></div>
                              </div>
                          </div>
                      </div>
                  </div>
      ...
      <section class="section video" data-section="section7">
          <div class="container">
              <div class="row">
                  <div class="col-md-6 align-self-center">
                      <div class="left-content">
                          <h4>Type of <em>Registration</em></h4>
          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="card">
                      <img src="../static/images/farmerregister.jpg" class="card-img-top" height="250px" alt="...">
                      <div class="card-body">
                          <h5 class="card-title"></h5>
                          <p class="card-text"></p>
                          <p class="card-text"></p>
                          <div class="down-content">
                              <div class="scroll-to-section main-button"><a rel="nofollow" href="#section8" target="_parent">Orphanage Registration</a></div>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="card">
                      <img src="../static/images/user1.png" class="card-img-top" height="250px" alt="...">
                      <div class="card-body">
                          <h5 class="card-title"></h5>
                          <p class="card-text"></p>
                          <p class="card-text"></p>
                          ...
                          <div class="down-content">
                              <div class="scroll-to-section main-button"><a rel="nofollow" href="#section9" target="_parent">Donor's Registration</a></div>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="card">
                      <img src="../static/images/authorregister.jpeg" class="card-img-top" height="250px" alt="...">
                      <div class="card-body">
                          <h5 class="card-title"></h5>
                          <p class="card-text"></p>
                          <p class="card-text"></p>
                          <div class="down-content">
                              <div class="scroll-to-section main-button"><a rel="nofollow" href="#section10" target="_parent">User Registration</a></div>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-5">
                      <div class="right-content">
                          <div class="top-content">
                              <h6>Orphanage<em>Register</em></h6>
                          </div>
                          <form id="contact" action="" method="get">
                              <div class="row">
                                  <div class="col-md-12">
                                  ...
                                  <div class="col-md-12">
                                      <fieldset>
                                          <button type="submit" id="form-submit" class="button">Registration</button>
                                      </fieldset>
                                  </div>
                              </div>
                          </form>
      ...
      <section class="section coming-soon" data-section="section9">
          <div class="container">
              <div class="row">
                  <div class="col-md-5">
                      <div class="right-content">
                          <div class="top-content">
                              <h6>Donor's<em>Register</em></h6>
                          </div>
                          <form id="contact" action="" method="get">
                              <div class="row">
                                  <div class="col-md-12">
      ...
      <section class="section coming-soon" data-section="section10">
          <div class="container">
              <div class="row">
                  <div class="col-md-5">
                      <div class="right-content">
                          <div class="top-content">
                              <h6>User <br/> <em>Register</em></h6>
                          </div>
                          <form id="contact" action="" method="get">
                              <div class="row">
                                  <div class="col-md-12">
