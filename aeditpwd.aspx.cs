...
public partial class aeditpwd : System.Web.UI.Page
{
    SqlConnection con;
    SqlConnection con1;
    String eid = "", s = "";
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            eid = Session["name"].ToString();

            s = "select * from admin where name=" + "'" + eid + "'" + " and  password=" + "'" + TextBox1.Text + "'";
            //Response.Write(s);
            con.Open();
            ...
            if (ctr == 1)
            {
                ...
                s = "update admin  set password=@p where name=@eid";
